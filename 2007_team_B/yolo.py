...
class YOLO(object):
    ...
    def generate(self):
        ...
        try:
            self.yolo_model = main_yolo.self_model
    ...
    def detect_image(self, image):
        ...
        # output dir 指定, なければ作成
        output_dir = 'output/' #'yolov3-tiny_pi/output/'
        ...
        #output dirに写真保存
        image.save(output_dir + 'result_{}.png'.format(file_name))
        ...
        return out_classes, out_scores, predicted_classes
